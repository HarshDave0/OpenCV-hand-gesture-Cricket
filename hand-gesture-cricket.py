...
print('\n')
print('Press b to start playing and pressing b captuers the movement i.e throwing ball here,\nSo repeatedly press b for throwing new balls.\n You are goingto bat first.')
print('\n')
...
while True:
    ...
    im2,contours, hierarchy = cv2.findContours(thresh1.copy(),cv2.RETR_TREE, \
